...
<br/>But when compare with **reference type** "==" compares if the object references are same while ".Equals()" compares if the contents are same.

1. "==" compare object references.
2. ".Equal()" compares only object contents.
